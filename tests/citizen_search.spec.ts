...
test.describe('Citizen Search Functionality', () => {
    ...
    test('Citizen Search - Valid ID', async () => {
        ...
        await citizenSearchPage.clickValidIDImage();
    });
    ...
    test('Citizen Search - Relationship', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
        ...
        await citizenSearchPage.verifyRelationshipContainer();
    });
    ...
    test('Citizen Search - Address Tab', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
        ...
        await citizenSearchPage.verifyAddressComboboxes();
    });
    ...
    test('Citizen Search - Proof of Billing', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
        ...
        await citizenSearchPage.verifyProofOfBillingCombobox();
    });
    ...
    test('Citizen Search - Contact', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
    ...
    test('Citizen Search - Basic Information', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
    ...
    test('Citizen Search - Cards', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
    ...
    test('Citizen Search - Other Information', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
        ...
        await citizenSearchPage.verifyOtherInfoComboboxes();
    });
    ...
    test('Citizen Search - Photo & Signature', async () => {
        const citizenSearchPage = new CitizenSearchPage(page);
        ...
        await citizenSearchPage.verifyPhotoSignatureImages();
    });
